...
function HeroSection() {
  return (
    <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-rose-50 via-orange-50 to-amber-50 dark:from-slate-900 dark:via-purple-900 dark:to-indigo-900">
      <div className="absolute inset-0">
        ...
        <div className="absolute -bottom-8 left-40 w-72 h-72 bg-gradient-to-r from-purple-400 to-pink-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-4000"></div>
      </div>
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center max-w-6xl mx-auto">
          ...
          <p className="text-xl sm:text-2xl text-gray-600 dark:text-gray-300 mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
            Capture brilliant ideas, organize thoughts, and save important links in one beautiful, 
            intelligent workspace designed for creative minds.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 text-center">
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg">
              <div className="text-3xl font-black bg-gradient-to-r from-pink-500 to-rose-500 bg-clip-text text-transparent mb-1">10K+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Happy Users</div>
            </div>
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg">
              <div className="text-3xl font-black bg-gradient-to-r from-orange-500 to-yellow-500 bg-clip-text text-transparent mb-1">1M+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Notes Created</div>
            </div>
            <div className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm rounded-2xl px-6 py-4 shadow-lg">
              <div className="text-3xl font-black bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent mb-1">500K+</div>
              <div className="text-sm text-gray-600 dark:text-gray-400 font-semibold">Links Saved</div>
            </div>
          </div>
        </div>
      </div>
...
export default function Dashboard() {
  ...
  if (!user) {
    return (
      <div>
        <PublicNavbar />
        <div className="relative min-h-screen overflow-x-hidden bg-gradient-to-br from-rose-25 via-orange-25 to-amber-25 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900 pt-16">
        {/* Unified Background Graphics */}
        <div className="absolute inset-0">
          <div className="absolute top-20 left-20 w-72 h-72 bg-gradient-to-r from-pink-400 to-rose-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob"></div>
          <div className="absolute top-40 right-20 w-72 h-72 bg-gradient-to-r from-yellow-400 to-orange-400 rounded-full mix-blend-multiply filter blur-xl opacity-30 animate-blob animation-delay-2000"></div>
          ...
          <div className="absolute bottom-20 right-40 w-64 h-64 bg-gradient-to-r from-orange-400 to-amber-400 rounded-full mix-blend-multiply filter blur-xl opacity-25 animate-blob animation-delay-6000"></div>
        </div>
        ...
        <div className="relative z-10">
            ...
            <div className="text-center max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-12 sm:mb-16 max-w-6xl mx-auto px-4">
                <div className="group relative transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-pink-500/10 to-rose-500/10 rounded-2xl group-hover:animate-pulse"></div>
                ...
                <div className="group relative transform hover:scale-105 transition-all duration-500 md:mt-8">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-orange-500/10 to-yellow-500/10 rounded-2xl group-hover:animate-pulse"></div>
                ...
                <div className="group relative transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-2xl group-hover:animate-pulse"></div>
          ...
          <div className="flex items-center justify-center my-6">
            ...
            <div className="mx-4 text-gray-400 dark:text-gray-500 text-sm font-medium">Trusted by thousands</div>
            <div className="h-px bg-gradient-to-r from-transparent via-gray-300 dark:via-gray-600 to-transparent w-full max-w-md"></div>
          </div>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-6 max-w-full">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mb-16 sm:mb-20 px-4">
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:rotate-1 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-blue-500/10 to-cyan-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-blue-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-xl flex items-center justify-center mb-4 group-hover:rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-blue-500/50">
              ...
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:-rotate-1 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-green-500 to-emerald-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-green-500/10 to-emerald-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-green-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mb-4 group-hover:-rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-green-500/50">
              ...
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:rotate-1 animate-fade-in-up" style={{animationDelay: '0.3s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-purple-500/10 to-indigo-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-purple-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-purple-500 to-indigo-500 rounded-xl flex items-center justify-center mb-4 group-hover:rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-purple-500/50">
              ...
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:-rotate-1 animate-fade-in-up" style={{animationDelay: '0.4s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-red-500 to-pink-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-red-500/10 to-pink-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-red-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-red-500 to-pink-500 rounded-xl flex items-center justify-center mb-4 group-hover:-rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-red-500/50">
              ...
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:rotate-1 animate-fade-in-up" style={{animationDelay: '0.5s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-orange-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-yellow-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-yellow-500 to-orange-500 rounded-xl flex items-center justify-center mb-4 group-hover:rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-yellow-500/50">
              ...
              <div className="group relative transform hover:scale-110 transition-all duration-500 hover:-rotate-1 animate-fade-in-up" style={{animationDelay: '0.6s'}}>
                <div className="absolute inset-0 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-2xl blur opacity-20 group-hover:opacity-50 transition-all duration-500 group-hover:blur-xl"></div>
                <div className="absolute inset-0 bg-gradient-to-r from-teal-500/10 to-cyan-500/10 rounded-2xl group-hover:animate-pulse"></div>
                <Card className="relative bg-white/90 dark:bg-slate-800/90 backdrop-blur-sm border border-white/60 rounded-2xl shadow-xl p-6 h-full group-hover:shadow-2xl group-hover:shadow-teal-500/25 transition-all duration-500">
                  <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-cyan-500 rounded-xl flex items-center justify-center mb-4 group-hover:-rotate-12 group-hover:scale-125 transition-all duration-500 shadow-lg group-hover:shadow-teal-500/50">
          ...
          {/* CTA Section - Seamlessly Integrated */}
  ...
  const allTags = [...new Set([...notes.flatMap(n => n.tags || []), ...bookmarks.flatMap(b => b.tags || [])])]
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-gradient-to-br from-rose-25 via-orange-25 to-amber-25 dark:from-slate-900 dark:via-slate-800 dark:to-indigo-900">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 max-w-full">
          ...
          <Card className="bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-xl">
            <CardContent className="p-8 text-center">
              ...
              <div className="text-4xl font-black bg-gradient-to-r from-purple-500 to-indigo-500 bg-clip-text text-transparent mb-2">
                {notes.filter(n => n.isFavorite).length + bookmarks.filter(b => b.isFavorite).length}
              </div>
        ...
        <div className="mt-8 sm:mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          <div className="group relative">
            ...
            <Card className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-xl p-6">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Use consistent tags like "work", "personal", "ideas" to organize your content. Click on stat cards above for quick actions!
              </p>
            </Card>
          </div>
          ...
          <div className="group relative">
            ...
            <Card className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white">Quick Start</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                {notes.length === 0 && bookmarks.length === 0 
                  ? 'Start by creating your first note or saving a bookmark. Use the floating action buttons!' 
                  : 'Great progress! Use search and filters to find content quickly. Mark important items as favorites.'}
              </p>
            </Card>
          </div>
          ...
          <div className="group relative">
            ...
            <Card className="relative bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm border border-white/50 rounded-2xl shadow-xl p-6">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="font-bold text-gray-900 dark:text-white">Boost Productivity</h3>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400 leading-relaxed">
                Visit Analytics to see your usage patterns. Use time filters to find recent content. Export important notes for backup.
              </p>
            </Card>
          </div>
        </div>
